...
<div class="ui segment">
	...
	<?php 
		if (isset($devs)) {
			$this->load->view('sections/user_cards', array('users' => $devs));
		} else {
			echo "None\n"; 
		}
	?>
...
<div class="ui segment">
	...
	<?php 
		if (isset($admins)) {
			$this->load->view('sections/user_cards', array('users' => $admins));
		} else {
			echo "None\n"; 
		}
	?>
...
<div class="ui segment">
	...
	<?php 
		if (isset($bloggers)) {
			$this->load->view('sections/user_cards', array('users' => $bloggers));
		} else {
			echo "None\n"; 
		}
	?>
...
<div class="ui segment">
	...
	<?php 
		if (isset($advertisers)) {
			$this->load->view('sections/user_cards', array('users' => $advertisers));
		} else {
			echo "None\n"; 
		}
	?>
